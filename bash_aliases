...
##########################
alias poweron-tc='sudo docker run -v /home/vagrant/.aws/credentials:/root/.aws/credentials:ro -v /vagrant/web-server/provisioner/instances:/root/instances:ro --name terraform_controller -d -h terraformController -p 2222:22 midockerdb/terraform-controller:0.1.2'
...
#Generate SSH Key
alias generate-key='ssh-keygen -t ed25519 -f /home/vagrant/rapture/web-server/provisioner/tf-packer'
